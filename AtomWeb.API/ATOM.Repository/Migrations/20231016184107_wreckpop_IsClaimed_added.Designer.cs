...
namespace ATOM.Repository.Migrations
{
    ...
    [Migration("20231016184107_wreckpop_IsClaimed_added")]
    partial class wreckpop_IsClaimed_added
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ATOM.Core.Entities.HelpPopulation", b =>
                {
                    b.HasOne("ATOM.Core.Entities.Category", "Category")
                        .WithMany("HelpPopulations")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
